    ...
    return {
        {
            ...
            draw = function(content)
                ...
                CONFIG.font:write(col2_x/2, HEIGHT - 5 * font_size_text, "Bitte bewertet die Vorträge auf", font_size_text, CONFIG.foreground_color.rgba())
                CONFIG.font:write(col2_x/2, HEIGHT - 4 * font_size_text + line_spacing , "http://bit.do/devday17", font_size_text, CONFIG.foreground_color.rgba())
            end
        }, {
